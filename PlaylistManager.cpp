...
void ProviderPlaylistManager::Read(IInvocationResponse& aResponse, TUint /*aVersion*/, TUint aId, TUint aTrackId, IInvocationResponseString& aUdn, IInvocationResponseString& aMetadata)
{
